...
<head>
      ...
      <body>
       ...
       <div class="form-group">
                             <input id="register-First name" type="First Name" name="fname" required class="input-material">
			                           <label for="register-First name" class="label-material">First Name
						   </label>
						                       </div>
	<div class="form-group">
	                      <input id="register-Last name" type="Last Name" name="lname" required class="input-material">
			                            <label for="register-Last name" class="label-material">Last Name
						    </label>
						                        </div>
	<div class="form-group">
	                      <input id="register-Phonenumber" type="Phone Number" name="phone" required
			      class="input-material">
			                            <label for="register-Phonenumber" class="label-material">Phone Number
						    </label>
						                        </div>
	 <div class="form-group">
	                       <input id="register-Birthdate" type="Birthday" name="bday" required class="input-material">
			                             <label for="register-Birthdate" class="label-material">Birthdate
						     </label>
						                         </div>
	<div class="form-group">
	...
	<div class="form-group">
	                      <input id="register-passowrd" type="password" maxlength="6" name="password" required
			      class="input-material">
			                            <label for="register-passowrd" class="label-material">password
						    </label>
						                        </div>
